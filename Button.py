...
class Button:
    def __init__(self, surface, x, y, width, height, state='', id='', function = 0, colour = (255,255,255), hover_colour=(255,255,255), border=True, border_width=2, border_colour=(255,255,255), text='', front_name='arial', text_size=20, text_colour=(0,0,0), bold_text = False):
        self.type = 'button'
        self.x = x
        self.y = y
        self.pos = vec(x, y)
    ...
    def show_text(self):
        font = pygame.font.SysFont(self.front_name, self.text_size, bold = self.bold_text)
